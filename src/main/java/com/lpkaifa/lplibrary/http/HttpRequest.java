...
public class HttpRequest {
	...
	private HttpResponse doRequest(int method) throws  IOException {
		...
		if(proxyAddress==null||"".equals(proxyAddress)||proxyPort==-1) {
